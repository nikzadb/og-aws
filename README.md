...
-   The maximum payload size (to communicate data between components) is 256K data. For more data than this limit, data must be stored/restored in other services such as s3, Dynamodb, Cache 
